package com.atlas.pharmacy.views.notetaker;
...
@PageTitle("Note Taker")
@Route(value = "note-taker", layout = MainLayout.class)
@PermitAll
public class NoteTakerView extends Main {

    public NoteTakerView() {
